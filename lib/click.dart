...
class click extends StatefulWidget {
  const click({Key? key,required this.path}) : super(key: key);
final path;
  @override
...
class _clickState extends State<click> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(resizeToAvoidBottomInset: false,
      body: /*Container(child:Image.file(File(widget.path)),)*/SingleChildScrollView(
        child: Column(
          children: [
            Stack(
            ...
            Row(
              children: [SizedBox(height:MediaQuery.of(context).size.height/10,
                ...
                CircleAvatar(child:IconButton(onPressed:(){},icon:Icon(Icons.send,color: Colors.white,)),backgroundColor: Colors.green,radius: 25,)
